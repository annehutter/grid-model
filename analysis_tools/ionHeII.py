...
if(solve_he > 0):
    ionfile = rp.identify_string(lines, rp.HeIIionfile_str, rp.splitting_str) #sys.argv[1]
    ...
    print "\n--------------------------------"
    print "Computing XHeII power spectra"
    print "--------------------------------"
    ...
    plt.ylabel('Log ( $\Delta^2_{X_\mathrm{HeII}}$ )')
